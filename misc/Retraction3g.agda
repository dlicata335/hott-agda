...
module misc.Retraction3g where
 ...
 module Monadic (B : Type) (b0 : B)
  ...
  Good-merge b x = <>
  Good-merge (τ ⇒ τ₁) x x₁ x₂ = {!OK!} , ({!OK!} , ({!OK!} , (Good-merge τ₁ _)))
  ...
  allgood (app e1 e2) θ gθ with allgood e1 θ gθ | allgood e2 θ gθ 
  ... | (ih1pot , ih1cst , ih1c) , ih1rec | (ih2pot , ih2cst , ih2c) , ih2rec 
    = ({! ih2pot!} , ({!!} , {!!})) , {!!}
