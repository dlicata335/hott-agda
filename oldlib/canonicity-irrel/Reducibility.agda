...
module canonicity-irrel.Reducibility where
...
-}
  ...
  ssubst' = λ sA {_}{_}{_}{vθ1}{vθ2} vα → smap (λ x → valuable _ (val (mred (ssubst sA (val vθ1) (val vθ2) (val≃ vα)) x))
                                              (ev (mred (ssubst sA (val vθ1) (val vθ2) (val≃ vα)) x) ∘ FIXMETodo) -- ev≃ vα
                                              FIXMEEval) 
                           (λ {_}{_}{_}{vM}{vN} vα' → valuable≃ _ (val≃ (mresp (ssubst sA (val vθ1) (val vθ2) (val≃ vα)) {_}{_}{_}{vM}{vN} vα')) (ev≃ (mresp (ssubst sA (val vθ1) (val vθ2) (val≃ vα)) {_}{_}{_}{vM}{vN} vα') ∘ FIXMETodo) FIXMEEval)
...
{-
  ...
  vRefl' {_}{vA} vM = valuable≃ 
                      _ (val≃0 {_}{_}{_}{_}{_}{val vM}{val vM} (vRefl (valty vA) (val vM))) (ev≃0 {_}{_}{_}{_}{_}{val vM}{val vM} (vRefl (valty vA) (val vM)) ∘ FIXMEChecked)
                      FIXMEEval
-}
...
{-       
  ...
  v!' vA {vM = vM} {vN = vN} vα = 
              valuable≃ _
                        (val≃0{_}{_}{_}{_}{_}{val vN}{val vM}  (v! (valty vA) (val≃ vα)))
  ...
  v∘' vA {vP = vP}{vN = vN}{vM = vM} vβ vα = 
                       valuable≃ _ (val≃0{_}{_}{_}{_}{_}{val vM}{val vP} (v∘ (valty vA){_}{_}{_}{_}{_}{val vP}{val vN}{val vM} (val≃ vβ) (val≃ vα))) 
