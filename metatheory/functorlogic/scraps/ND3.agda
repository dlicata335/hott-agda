...
module functorlogic.ND3 where
  ...
  substaa D (Let E1 E2) = Let (substaa D E1) E2
  ...
  mutual
    ...
    hsubsta D (FE E) | Func e1 E' e e2 = Func e1 (FE E') e (1⇒ ∘1cong e2)
    hsubsta D (FE E) | FI E' = E'
    hsubsta D (Let D1 D2) = hsubstc (hsubsta D D1) D2

    hsubstc : ∀ {p q r s : Mode} {A : Tp p} {α : s ≤ p} {B : Tp q} {β : s ≤ q} {C : Tp r} {γ : s ≤ r}
           → A [ α ]⇑ B [ β ]
           → B [ β ]⇑ C [ γ ]
           → A [ α ]⇑ C [ γ ]
    hsubstc D (Func e1 x e e2) = {!!}
    hsubstc D (FI E) = FI (hsubstc D E)
