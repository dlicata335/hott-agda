...
module functorlogic.ND where
  ...
  func : ∀ {r s t t'} {α : s ≤ t} {β : s ≤ t'} {γ : r ≤ t} {γ' : r ≤ t'} {δ δ' : s ≤ r}  {A : Tp t} {B : Tp t'}
              ...
              → (e2 : (γ' ∘1 δ' ) ⇐ β)
              → A [ α ]⇑ B [ β ] 
  func {γ = γ}{γ'}{δ = δ}{δ' = δ'} e1 (Func {γ = γ1} {γ' = γ1'} {δ = δ1} {δ' = δ1'} e1' D e2' e3') e2 e3 = Func {γ = γ1} {γ' = γ1'} {δ = δ1 ∘1 δ} {δ' = δ1' ∘1 δ' } ((e1' ∘1cong 1⇒) ·2 e1) D (e2' ∘1cong e2) (e3 ·2 (e3' ∘1cong 1⇒))
  func e1 (FI D) e e2 = FI (func e1 D e (1⇒ ∘1cong e2)) 
  ...
  substac : ∀ {p q r s : Mode} {A : Tp p} {α : r ≤ p} {B : Tp q} {β : r ≤ q} {C : Tp s} {γ : r ≤ s}
          → A [ α ]⇓ B [ β ]
          → B [ β ]⇑ C [ γ ]
          → A [ α ]⇑ C [ γ ]
  substac D (Func e1 E e e2) = {!substaa D E!}
  substac D (FI E) = FI (substac D E)
