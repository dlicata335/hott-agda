...
module homotopy.TS1S1 where
  ...
  c2t'-β = _ , _ , 
          ...
          out-SquareOver-= (apdo-by-equals _ _ _ (λ≃ (\ y -> ap (ap (λ f → f y)) (S¹.βloop/rec (S¹-rec a q) (λ≃ c2t-loop-homotopy))))) ·-cube-h
  ...
  c2t2c = S¹-elimo _ 
           (S¹-elimo _ id (in-PathOver-= (square-symmetry loop2-case))) 
