...
univalence axiom~\citep{nps90mltt,hofmann97syntaxandsemantics,martinlof71itt} and higher-dimensional inductive
...
\item Calculating $\pi_n(S^n)$ is a relatively
  easy theorem in algebraic topology (e.g. it would come early in a
  graduate algebraic topology course), but it is more complex than many of
  the results that had previously been proved in homotopy type theory.
  For example, it was one of the first results about an infinite family
  of spaces, of variable dimension.
