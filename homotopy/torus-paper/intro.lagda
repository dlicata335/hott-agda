...
pushouts that is used in the construction of the Hopf fibration,\footnote{The Agda code is in github.com/guillaumebrunerie/} and
...
and higher cube-over-a-cube types to represent cubes in a fibration
(dependent type).
