...
|Path a b| for the equality type).  Using higher inductive types, we
describe a circle as being generated by a point and a loop.  The picture
\begin{center}
  \begin{tikzpicture}
...
torus is the free type with two loops that commute.
